...
To reduce the number of covariates even further several supervised machine learning algorythms were explored to include only the most important predicting covariates.
