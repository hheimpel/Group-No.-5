...
master_2002_num <- master_2002 %>%
  select_if(is.numeric) %>%
  select(-c(hhid,individual_id, age, state, municipality, id_loc, community, attend_school,
        work_1hr, work_fam_bus, work_ever, care_elderly, watch_tv, telephone, sleep_kitchen,
        same_drink_wash_water, carried_firewood, doctor_visit, cook_room))
