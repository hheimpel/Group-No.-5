...
3. `c_cvo`: this data set extends the previous one with more physical characteristics of the households (i.e. the construcction materials, access to electricity, etc.). This is a household level data set.
4. `c_ls`: it contains control characteristics such as income, level of education, gender, among others. This is an individual level data set.
